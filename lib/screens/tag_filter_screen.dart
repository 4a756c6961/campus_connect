...
class TagFilterScreen extends StatelessWidget {
  final String tag;
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream:
            FirebaseFirestore.instance
                .collection('posts')
                .where('tags', arrayContains: cleanTag)
                .snapshots(),
        builder: (context, snapshot) {
          ...
          docs.sort((a, b) {
            ...
            final aCreatedAt =
                aCreatedAtRaw is Timestamp ? aCreatedAtRaw.toDate() : null;
            final bCreatedAt =
                bCreatedAtRaw is Timestamp ? bCreatedAtRaw.toDate() : null;
          ...
          if (docs.isEmpty) {
            return Center(
              child: Text('Noch keine Beiträge mit #$cleanTag.'),
            );
          }
                      ...
                      return PostCard(
                        ...
                        onTagTap: (selectedTag) {
                          ...
                          Navigator.of(context).pushReplacement(
                            MaterialPageRoute(
                              builder:
                                  (_) => TagFilterScreen(tag: selectedTag),
                            ),
                          );
                        },
                        onToggleLike:
